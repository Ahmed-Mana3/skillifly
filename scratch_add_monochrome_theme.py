...
# Create the theme
theme, created = Theme.objects.get_or_create(name='Monochrome', category=category)

if created:
    print("Theme 'Monochrome' created successfully.")
else:
    print("Theme 'Monochrome' already exists.")
...
if test_user:
    ...
    profile.theme = theme
    profile.save()
    print(f"Assigned 'Monochrome' theme to test user '{test_user.username}'.")
else:
